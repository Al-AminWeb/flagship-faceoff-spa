        ...
        <div className="navbar p-0 bg-base-100 shadow-sm">
            ...
            <div className="navbar-end hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <li><NavLink className={({isActive})=>(isActive ? 'text-indigo-500':'')} to='/cart'>Cart</NavLink></li>
                    <li><NavLink className={({isActive})=>(isActive ? 'text-indigo-500':'')} to='/favorites'>Favorites</NavLink></li>
                </ul>
            </div>
        </div>
    );
